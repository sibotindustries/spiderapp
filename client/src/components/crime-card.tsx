...
export function CrimeCard({ crime, expanded = false, onExpand }: CrimeCardProps) {
  ...
  return (
    <div className={`crime-report bg-gradient-to-r from-card/80 to-card/60 rounded-lg ${isMobile ? 'p-3 mb-2' : 'p-4 mb-4'} border ${expanded ? 'border-primary/40' : 'border-primary/20'} relative`} onClick={() => !expanded && onExpand?.(crime)}>
